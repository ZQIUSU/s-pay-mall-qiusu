...
import site.zqiusu.common.weixin.MessageTextEntity;
import site.zqiusu.common.weixin.SignatureUtil;
import site.zqiusu.common.weixin.XmlUtil;
import site.zqiusu.service.ILoginService;

import javax.annotation.Resource;

/**
 * https://apis.zqiusu.site/api/v1/weixin/portal/receive/
 */
@Slf4j
@RestController()
@CrossOrigin("*")
    ...
    public String post(@RequestBody String requestBody,
        ...
        try {
            ...
            if ("event".equals(message.getMsgType()) && "SCAN".equals(message.getEvent())) {
                ...
                return buildMessageTextEntity(openid, "哎呦你干嘛");
            }
